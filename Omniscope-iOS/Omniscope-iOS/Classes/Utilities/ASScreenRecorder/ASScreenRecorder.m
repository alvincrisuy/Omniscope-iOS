...
NSString *const CSAlbum3 = @"Omniscope";
...
//                NSLog(@"rootView: %@", [OSAppDelegate sharedDelegate].rootViewController);
//                NSLog(@"contentNavigation: %@", [OSAppDelegate sharedDelegate].rootViewController.contentNavigationController);
//                NSLog(@"visibleController: %@", [OSAppDelegate sharedDelegate].rootViewController.contentNavigationController.visibleViewController);
//                NSLog(@"view: %@", [OSAppDelegate sharedDelegate].rootViewController.contentNavigationController.visibleViewController.view);
                
                [[OSAppDelegate sharedDelegate].rootViewController.contentNavigationController.visibleViewController.view drawViewHierarchyInRect:CGRectMake(0, 0, _viewSize.width, _viewSize.height) afterScreenUpdates:NO];
