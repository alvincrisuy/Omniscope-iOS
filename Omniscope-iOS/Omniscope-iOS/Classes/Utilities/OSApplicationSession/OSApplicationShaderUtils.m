...
@implementation OSApplicationShaderUtils
...
+ (int)createProgramWithVertexShaderFileName:(NSString*) vertexShaderFileName
    ...
    return [OSApplicationShaderUtils createProgramWithVertexShaderFileName:vertexShaderFileName
